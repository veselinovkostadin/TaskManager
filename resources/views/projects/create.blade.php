...
<div class="p-6">
    <h1 class="text-2xl font-bold text-blue-900 mb-4">Create New Project</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('projects.store') }}" method="POST">
            ...
            <div class="flex justify-between items-center">
                <a href="{{ route('projects.index') }}" class="text-sm text-blue-900 hover:text-blue-700">Cancel</a>
